    ...
    def _assert_about_win_dict(self, win_dict):
        for field_name in WinSerializer().fields:
            ...
            try:
                self.assertEquals(
                    win_dict[csv_name],
                    self._val_to_str(getattr(self.win1, field_name)),
                )
